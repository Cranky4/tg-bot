...
func (c *reporterClient) SendReport(ctx context.Context, in *SendReportRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/tgBot.Reporter/SendReport", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReporterServer) SendReport(context.Context, *SendReportRequest) (*emptypb.Empty, error) {
...
func _Reporter_SendReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tgBot.Reporter/SendReport",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReporterServer).SendReport(ctx, req.(*SendReportRequest))
	}
